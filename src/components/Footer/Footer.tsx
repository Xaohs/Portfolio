  ...
  return (
    <footer className=" rounded-lg bg-black-1 p-4 text-gray-200 shadow md:px-6 md:py-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div className="flex flex-col text-xl opacity-80 hover:opacity-100 ">
          <span className="last:mr-00  mx-4   ">Julian</span>
          <span className="mx-4   last:mr-0  ">Roeland</span>
        </div>
        <ul className="mb-6 flex flex-wrap items-center justify-end text-xl sm:mb-0">
          <li>
